Pod::Spec.new do |s|
  s.name         = "LXLibs_OC"
  s.version      = "1.0.0"
  s.summary      = "This is my(lixiao) LXLibs_OC"
  ...
  s.source       = { :git => "https://github.com/lixiao7215981/LXLibs_OC.git", :tag => s.version }

  s.source_files  = "LXLibs_OC/LXLibs_OC/Classes/**/*.{h,m}"
  s.resources = "LXLibs_OC/LXLibs_OC/Source/**/LXFrameWork.bundle"
